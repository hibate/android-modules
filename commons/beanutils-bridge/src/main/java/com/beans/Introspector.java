...
public class Introspector {
            ...
            throws IntrospectionException
    {
        ...
        BeanInfo beanInfo = new Introspector(beanClass, null, USE_ALL_BEANINFO).getBeanInfo();
        return beanInfo;
    }
    ...
    private BeanInfo getBeanInfo() throws IntrospectionException {
        ...
        return new GenericBeanInfo(bd, defaultEvent, pds,
                defaultProperty, explicitBeanInfo);
    ...
    private static Class<?> findCustomizerClass(Class<?> type) {
        ...
        try {
            ...
            // Each customizer should inherit java.awt.Component and implement Customizer
