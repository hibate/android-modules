 ...
 * make it easy and natural to access the property values of your java.beans using
 ...
 * classes like <code>java.Introspector</code>, which can examine a Java
 ...
 * should not be accessible on java.beans has to be provided. These properties will
 ...
 * property which is per default available for all java.beans; it is generated from the
 ...
 * of your java.beans, but you've got a bunch of existing standard JavaBeans classes
 ...
 *          <code>java.util.Map</code>'s or POJO java.beans.</li>
 ...
 *     <ul>
 *         <li><strong><i>Lazy</i> property addition</strong> - lazy java.beans use a
 ...
 *              properties. <i>Lazy</i> java.beans use this feature to automatically add
 ...
 *      <code>java.util.Map</code>'s or POJO java.beans. See the <a href="LazyDynaList.html">Javadoc</a>
 ...
 * that compares java.beans based on a shared property value.
 * </p>
 ...
 * so that all the java.beans in a collection can have a particular property set to a particular value.
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 * For example, to filter a collection to find all java.beans where active employee is false use:
 * <code><pre>
 ...
 * <li>The <code>java.Introspector</code> searches widely for a custom <em>BeanInfo</em>
