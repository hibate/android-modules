...
/**
 * <p>
 * This comparator compares two java.beans by the specified bean property.
 * It is also possible to compare java.beans based on nested, indexed,
 ...
 * specified in the constructor. If you are comparing two java.beans based
 ...
 * </p>
 *
 * @param <T> the type of java.beans to be compared by this {@code Comparator}
...
public class BeanComparator<T> implements Comparator<T>, Serializable {
    ...
    /**
     * <p>Constructs a property-based comparator for java.beans.
     * This compares two java.beans by the property
    ...
    /**
     * Constructs a property-based comparator for java.beans.
    ...
    /**
     * Gets the Comparator being used to compare java.beans.
     *
     * @return the Comparator being used to compare java.beans
     */
